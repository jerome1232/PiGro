...
#
# It facilitates communication between the arduino Uno and the webserver
# to visualize sensor data from a greenhouse and to send desired watering,
# lighting, etc... thresholds to the arduino.
#
# It will loop forever constantly checking for communication
# over the serial line from an Arduino, and checking a UDS
# for data arriving from apace2 to send to the arduino.

def main():
    uno = commune_arduino.CommuneArduino()
    server = sock_server.SockServer(location='/home/pi/PiGro/www/cgi/sock')
